...
export function updatePieCharts() {
  ...
  const pie2Data = createPieData(pie2Raw, 0.5);
...
// Optional: call immediately if DOM is ready
document.addEventListener("DOMContentLoaded", () => {
  // Wait for appState to be populated by main.js
  setTimeout(updatePieCharts, 0);
});
